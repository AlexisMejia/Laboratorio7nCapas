...
public class MainController {
	...
	public ModelAndView findOne(@RequestParam(value = "codigoEstudiante") int id) {
		ModelAndView mav = new ModelAndView();
	...
	public ModelAndView delete(@RequestParam(value = "codigoEstudiante") int id) {
		ModelAndView mav = new ModelAndView();
		List<Estudiante> estudiantes = null;
	...
	@PostMapping("/editar")
	public ModelAndView edit(@RequestParam(value="codigoEstudiante") int id) {
		ModelAndView mav = new ModelAndView();
		Estudiante est = estudianteService.findOne(id);
		
		mav.addObject("estudiante", est);
